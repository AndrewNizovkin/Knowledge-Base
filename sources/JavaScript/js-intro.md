...
- `string` для строк. Строка может содержать ноль или больше символов, нет отдельного символьного типа. Строки не изменяемы.
...
alert("12sdf4".[2])
alert("12sdf4".at(-2)) // -2 от конца строки
// получение символа из строки. В случае с 'at' возможна относительная адресация. 

str.substring(indexA[, indexB])
// возвращает часть строки от начального индекса до конечного (не включая его), или, если конечный индекс не указан, — до конца строки.

str.slice(start[, ent])
// то-же, что и предыдущее, но есть ньюансы. Более гибок и предпочтителен.
...
// озвращает индекс последнего вхождения указанного значения в строковый объект String, на котором он был вызван, или -1, если ничего не было найдено. Поиск по строке ведётся от конца к началу, начиная с индекса fromIndex.

str.includes(substr[, pos])
// возвращает true, если в строке str есть подстрока substr, либо false, если нет.
