...
`Митигации` - это мероприятия по снижению вероятности наступления рискового события и уменьшению ущерба, если оно всё же произойдет. Она бывает проактивной (предотвращение до начала) и реактивной (борьба с последствиями).
...
- Постановка задач на день - планирование дня
