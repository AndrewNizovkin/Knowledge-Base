...
> Для избегания проблем, связанных с выходом размеров элементов, центрируемых с помощью свойств `justify-content` и `align-items` следует использовать ключевое слово `safe`
